...
class TspServiceInfo(models.Model):
    ...
    tsp_service_status = models.CharField(verbose_name="Service Status", max_length=50, choices=TspServiceStatus.choices)
...
class TslValidityInfo(models.Model):
    ...
    def __str__(self):
        return "Country: " + str(self.country_name) + " — TSL Operator: " + str(self.tsl_operator_name)
